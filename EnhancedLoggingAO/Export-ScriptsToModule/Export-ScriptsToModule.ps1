...
# Load Ondrej's Export-ScriptsToModule function
# . "C:\Code\modules-beta\InProgress\Export-ScriptsToModule.ps1"
...
$destinationPath = "C:\Code\Modules-Beta\enhancedloggingAO\2.5.0\GeneratedModule"
...
# Execute Ondrej's Export-ScriptsToModule function for public functions
Export-ScriptsToModule @{
    $publicPath = $destinationPath
}

# Append private functions to the generated module file
$moduleFile = Join-Path -Path $destinationPath -ChildPath "EnhancedLoggingAO-beta.psm1"
...
# Output result
Write-Host "Module generated at: $destinationPath" -ForegroundColor Green