...
function Create-KeePassDatabase {
    ...
    echo $password | & keepassxc-cli db-create --set-password $dbPath
}
...
function Add-KeePassEntry {
    ...
    # Combine the database password and entry password inputs
    $inputString = "$dbPassword`n$entryPassword"
